...
class PDF():
    def __init__(self,name):
        ...
        self._pdf.cell(0, 60, 'CS50 certificate.', new_x="LMARGIN", new_y="NEXT", align='C') #To add a new cell next to it with centered text and go to the next line
        self._pdf.image("shirtificate.png", w=self._pdf.epw)
        self._pdf.set_font_size(30)
        self._pdf.set_text_color(255,255,255) #To make it white
...
name=input('Name: ')
pdf=PDF(name)
pdf.save('shirtificate.pdf')  #Output of the code, in brackets the name we want to save our file
